...
impl<E> From<SpecViolation> for DispatcherError<E> {
    fn from(spec: SpecViolation) -> Self { panic!("STUB: not implemented") }
}
...
impl ProtocolError {
    pub(crate) fn violation(reason: DisconnectReasonCode, message: &'static str) -> Self { panic!("STUB: not implemented") }

    pub fn spec(err: SpecViolation) -> Self { panic!("STUB: not implemented") }

    pub fn generic_violation(message: &'static str) -> Self { panic!("STUB: not implemented") }

    pub(crate) fn unexpected_packet(packet_type: u8, message: &'static str) -> ProtocolError { panic!("STUB: not implemented") }
    pub(crate) fn packet_id_mismatch() -> Self { panic!("STUB: not implemented") }
}

impl<E> From<io::Error> for MqttError<E> {
    fn from(err: io::Error) -> Self { panic!("STUB: not implemented") }
}

impl<E> From<Either<io::Error, io::Error>> for MqttError<E> {
    fn from(err: Either<io::Error, io::Error>) -> Self { panic!("STUB: not implemented") }
}

impl<E> From<EncodeError> for MqttError<E> {
    fn from(err: EncodeError) -> Self { panic!("STUB: not implemented") }
}

impl<E> From<Either<DecodeError, io::Error>> for HandshakeError<E> {
    fn from(err: Either<DecodeError, io::Error>) -> Self { panic!("STUB: not implemented") }
}
...
impl<T: fmt::Debug> From<Either<DecodeError, std::io::Error>> for ClientError<T> {
    fn from(err: Either<DecodeError, std::io::Error>) -> Self { panic!("STUB: not implemented") }
}
